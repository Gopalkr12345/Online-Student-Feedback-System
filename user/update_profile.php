	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					Travelling<input value="traveling" <?php if(in_array("travelling",$arrr)){echo "checked";} ?> type="checkbox" name="hob[]"/>
					Swimming<input value="swimming" <?php if(in_array("swimming",$arrr)){echo "checked";} ?> type="checkbox" name="hob[]"/>
